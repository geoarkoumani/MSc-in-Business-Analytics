...
The aim of the project was to implement a machine learning idea that provides a solution to a specific problem.
...
## Final dataset
The final dataset that is used to train the models consists of: 
...
## Future Work
The main aim is to expand the application's features to support funcionalities e.g. 